-- Add cover_scale column to events table.
-- Stores zoom level for cover photo (1.0 = no zoom, 2.0 = 2x zoom).

alter table public.events
  add column if not exists cover_scale real default 1.0;

-- Update get_public_event RPC to include cover_scale.
