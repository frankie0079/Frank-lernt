...
export function buildStoryboardSystemPrompt(): string {
  return [
    ...
    "- **DU MUSST JEDES content_item aus <user_content> vom Typ photo oder video in GENAU EINER",
    "  Szene verwenden (als Szenentyp 'photo' oder 'video' mit passender content_item_id).**",
    "  Kuratiert = muss in den Film. Niemals Fotos/Videos weglassen.",
    "- Ziel-Dauer pro Szene: 4-5 s. Bei vielen Items darfst du auf 3 s runter, bei wenigen bis 6 s hoch.",
    "  Rechne: (50000 − 3000 für die cover-Szene) / Anzahl Fotos+Videos ≈ Ziel-Dauer pro Szene.",
    ...
    "  Die cover-Szene ist zusätzlich zu den Foto/Video-Szenen und zählt NICHT gegen die \"alle Items\"-Regel.",
    ...
    "  mit Autor, oder ein Kapitel-/Übergangstitel. Bei Fotos ohne besonderen Kommentar: leer lassen.",
