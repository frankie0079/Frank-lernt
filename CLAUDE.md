...
Alle Features in `features/INDEX.md`. Features: PROJ-24 bis PROJ-47. v1 (PROJ-1–23) wurde gelöscht.
...
- **PROJ-41: Tour-Tracker** — Superseded 2026-06-12. Der eigene GPS-Tour-Tracker wurde nach realem App-Test entfernt, weil die Qualität gegenüber Komoot nicht ausreicht. Künftiger Ablauf: Route extern tracken, daraus ein gutes Tracking-Bild erzeugen und in EventDocs als normales Foto hochladen. Bestehende alte Tour-Report-Fotos bleiben im Content-Pool/Tagebuch lesbar.
...
- **PROJ-46: MP4-Filmstruktur neu** — Deployed 2026-06-09. Tagesfilme bestehen nur noch aus editierbarer Startseite, maximal 12 Fotos/Videos und editierbarer Schlussseite. Start-/Schlussbild wählbar aus Event-Cover oder kuratierten Fotos; Texte frei editierbar. Jede Medienszene dauert 4–6 Sekunden. Alte `chapter-title`, `text-card`, Cover- und Leerszenen werden beim Laden/Speichern entfernt. Bei mehr als 12 Medien werden Planung, Speichern und Rendern blockiert statt Bilder auszulassen. Video-Player zeigen ein Posterbild statt schwarzer Fläche. Production-Smoke mit Tirana: Poster sichtbar, neun reine Fotoszenen à 4,0 Sekunden, keine Wortkarten. Bestehende MP4s ändern sich erst nach erneutem Rendern.
- **PROJ-47: Tagesfilm-Stile** — Deployed 2026-06-09. Der Storyboard-Editor bietet `Postkarte`, `Tagesrückblick` und `Reisetagebuch`. Die Stilwahl wird im vorhandenen Storyboard-JSON gespeichert; alte Storyboards fallen auf `Postkarte` zurück. Postkarte nutzt den bisherigen ruhigen Stil, Tagesrückblick ergänzt Tagesmarker/Szenenzähler/Reveal, Reisetagebuch nutzt Papierfläche/Fotorahmen/Kommentarbereich. Keine Migration und keine automatische Änderung bestehender MP4s. Production-Smoke mit Tirana: Tagesrückblick gespeichert und neu geladen, anschließend wieder auf Postkarte zurückgesetzt; kein MP4 überschrieben.
...
### Nächster Schritt
Nächster fachlicher Schritt nach Bedarf: Tirana-Filme mit der neuen Struktur neu rendern oder ein neues Feature als PROJ-47 mit `/requirements` starten. Bestehende MP4s bleiben bis zum erneuten Rendern unverändert.

### Build-Reihenfolge
1. ~~PROJ-24~~ ✅ ~~PROJ-25~~ ✅ ~~PROJ-26~~ ✅ ~~PROJ-27~~ ✅ ~~PROJ-28~~ ✅ ~~PROJ-29~~ ✅ ~~PROJ-30~~ ✅ ~~PROJ-31~~ ✅ ~~PROJ-32~~ ✅ ~~PROJ-33~~ ✅ ~~PROJ-34~~ ✅ ~~PROJ-35~~ ✅ ~~PROJ-36~~ ✅ ~~PROJ-37~~ ✅ ~~PROJ-38~~ ✅ ~~PROJ-39~~ ✅ ~~PROJ-40~~ ✅ PROJ-41 Superseded PROJ-42 In Review ~~PROJ-43~~ ✅ ~~PROJ-44~~ ✅ ~~PROJ-45~~ ✅ ~~PROJ-46~~ ✅ ~~PROJ-47~~ ✅
